...
export default function VideoCallsDashboard() {
  ...
  const recentVideoCalls = [
    { id: 1, name: 'Fatima El Mahdaoui', company: 'Enterprise Hub', phone: '+212 661-987-654', email: 'fatima.elmahdaoui@enterprisehub.ma', time: '11:15 AM', duration: '25m 14s', type: 'incoming', status: 'completed', quality: 'HD', participants: 3 },
    { id: 2, name: 'Tarik El Yazidi', company: 'Smart Systems', phone: '+212 678-987-543', email: 'tarik.yazidi@smartsystems.ma', time: '10:30 AM', duration: '18m 45s', type: 'outgoing', status: 'completed', quality: '4K', participants: 2 },
    { id: 3, name: 'Anouar El Ghali', company: 'Tech Innovations', phone: '+212 655-234-567', email: 'anouar.ghali@techinnovations.ma', time: '9:45 AM', duration: '7m 23s', type: 'incoming', status: 'missed', quality: 'HD', participants: 1 },
    { id: 4, name: 'Ahmed Ait Ali', company: 'Global Solutions', phone: '+212 642-876-543', email: 'ahmed.aitali@globalsolutions.ma', time: '9:20 AM', duration: '32m 18s', type: 'outgoing', status: 'completed', quality: '4K', participants: 5 }
  ];

  const favoriteContacts = [
    { name: 'Maizzou Hanane', company: 'Design Studio', phone: '+212 661-456-789', status: 'online', camera: true },
    { name: 'Kamal Belkadi', company: 'Tech Ventures', phone: '+212 678-765-432', status: 'busy', camera: false },
    { name: 'Mohamed Allaoui', company: 'Creative Agency', phone: '+212 655-342-567', status: 'offline', camera: true },
    { name: 'Mounir Hafid', company: 'Digital Corp', phone: '+212 642-123-456', status: 'online', camera: true }
  ];
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3">
          ...
          >
            <i className="ri-video-fill w-4 h-4 flex items-center justify-center"></i>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="bg-white rounded-lg px-8 py-6 shadow-lg border border-gray-100">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-600 mb-1">Today's Video Calls</p>
            ...
            <div className="bg-blue-50 w-14 h-14 rounded-lg flex items-center justify-center">
              <i className="ri-video-fill text-blue-600 w-7 h-7 flex items-center justify-center"></i>
            </div>
          </div>
        </div>
        <div className="bg-white rounded-lg px-8 py-6 shadow-lg border border-gray-100">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-gray-900">6h 47m</p>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-white rounded-lg shadow-lg border border-gray-100">
          <div className="p-6 border-b border-gray-200">
            <div className="flex items-center justify-between">
              <h2 className="text-xl font-bold text-gray-900">Video Call History</h2>
                ...
                <div key={call.id} className="flex items-center justify-between p-4 hover:bg-gray-50 rounded-lg transition-colors border border-gray-100">
                  ...
                  <div className="text-right">
                    ...
                    <div className="flex items-center space-x-2 mt-2">
                      ...
                      <button className="p-1 text-gray-400 hover:text-purple-600 cursor-pointer">
                        <i className="ri-message-3-fill w-4 h-4 flex items-center justify-center"></i>
                      </button>
                    </div>
                  </div>
                </div>
        ...
        <div className="bg-white rounded-lg shadow-lg border border-gray-100">
          <div className="p-6 border-b border-gray-200">
            <h2 className="text-xl font-bold text-gray-900">Quick Video Call</h2>
          </div>
          <div className="p-6">
            <div className="space-y-4">
      ...
      {/* New Video Call Modal */}
      {showVideoCallModal && modalContainer && createPortal(
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[99999]" style={{position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, zIndex: 99999}}>
          <div className="bg-white rounded-lg p-6 w-96 shadow-xl relative">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-xl font-bold text-gray-900">Start New Video Call</h2>
              <button 
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-2">
                <input type="checkbox" id="videoTranslation" className="rounded" />
                <label htmlFor="videoTranslation" className="text-sm text-gray-700">Enable AI Translation</label>
              </div>
